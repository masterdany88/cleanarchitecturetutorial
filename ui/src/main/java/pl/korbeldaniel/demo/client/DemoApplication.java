...
import pl.korbeldaniel.demo.client.filter.LoginFilter;
 ...
 */
@Application(
    context = DemoContext.class,
    startRoute = "/login/login",
    loader = DemoLoader.class,
...
public interface DemoApplication extends IsApplication {
}
